$.fn.surveyEdit = function () {
    ...
    var questionItem = {
        topButton: '<div class="col-md-6 text-right" style="float: left;"><button class="btn question-button-delete"></button><button class="btn question-button-save"></button></div>',
